...
- 🔌 **Wide protocol support** — Shadowsocks, ShadowsocksR, V2Ray, VMess, VLESS, Trojan, Socks5, and WireGuard
- 🎯 **Smart routing modes** — bypass local network traffic, bypass specific regions, or filter by process
...
- 64-bit (x64) system
- Administrator access (needed for network driver and routing features)
